...
/**
 * Base class that represents a row from the 'bookmarks' table.
 *
 *
 *
 * @package    propel.generator.Models.Bookmarks.Base
 */
abstract class Bookmarks implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Models\\Bookmarks\\Map\\BookmarksTableMap';
    ...
    /**
     * Initializes internal state of Models\Bookmarks\Base\Bookmarks object.
     */
    ...
    /**
     * Compares this with another <code>Bookmarks</code> instance.  If
     * <code>obj</code> is an instance of <code>Bookmarks</code>, delegates to
     * <code>equals(Bookmarks)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Bookmarks The current object, for fluid interface
     */
     ...
     * @return $this|\Models\Bookmarks\Bookmarks The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[BookmarksTableMap::COL_ID] = true;
        }
    ...
    public function setEpisodeId($v)
    {
        ...
        if ($this->episode_id !== $v) {
            $this->episode_id = $v;
            $this->modifiedColumns[BookmarksTableMap::COL_EPISODE_ID] = true;
        }

        if ($this->aEpisodes !== null && $this->aEpisodes->getId() !== $v) {
            $this->aEpisodes = null;
        }
    ...
    public function setNotes($v)
    {
        ...
        if ($this->notes !== $v) {
            $this->notes = $v;
            $this->modifiedColumns[BookmarksTableMap::COL_NOTES] = true;
        }
    ...
    public function setCreatedAt($v)
    {
        ...
        if ($this->created_at !== null || $dt !== null) {
            if ($this->created_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[BookmarksTableMap::COL_CREATED_AT] = true;
            }
    ...
    public function setUpdatedAt($v)
    {
        ...
        if ($this->updated_at !== null || $dt !== null) {
            if ($this->updated_at === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->updated_at->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[BookmarksTableMap::COL_UPDATED_AT] = true;
            }
        } // if either are not null
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : BookmarksTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : BookmarksTableMap::translateFieldName('EpisodeId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->episode_id = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : BookmarksTableMap::translateFieldName('Notes', TableMap::TYPE_PHPNAME, $indexType)];
            $this->notes = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : BookmarksTableMap::translateFieldName('CreatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            $this->created_at = (null !== $col) ? PropelDateTime::newInstance($col, null, 'DateTime') : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : BookmarksTableMap::translateFieldName('UpdatedAt', TableMap::TYPE_PHPNAME, $indexType)];
            if ($col === '0000-00-00 00:00:00') {
                $col = null;
            }
            ...
            return $startcol + 5; // 5 = BookmarksTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Models\\Bookmarks\\Bookmarks'), 0, $e);
        }
    }
    ...
    {
        if ($this->aEpisodes !== null && $this->episode_id !== $this->aEpisodes->getId()) {
            $this->aEpisodes = null;
        }
    } // ensureConsistency
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildBookmarksQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Bookmarks::setDeleted()
     * @see Bookmarks::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildBookmarksQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($isInsert) {
                ...
                if (!$this->isColumnModified(BookmarksTableMap::COL_CREATED_AT)) {
                    $this->setCreatedAt($highPrecision);
                }
                if (!$this->isColumnModified(BookmarksTableMap::COL_UPDATED_AT)) {
                    $this->setUpdatedAt($highPrecision);
                }
            } else {
                $ret = $ret && $this->preUpdate($con);
                // timestampable behavior
                if ($this->isModified() && !$this->isColumnModified(BookmarksTableMap::COL_UPDATED_AT)) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BookmarksTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doSave(ConnectionInterface $con)
    {
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->aEpisodes !== null) {
                if ($this->aEpisodes->isModified() || $this->aEpisodes->isNew()) {
                    $affectedRows += $this->aEpisodes->save($con);
                }
                $this->setEpisodes($this->aEpisodes);
            }
            ...
            if ($this->userEpisodessScheduledForDeletion !== null) {
                if (!$this->userEpisodessScheduledForDeletion->isEmpty()) {
                    foreach ($this->userEpisodessScheduledForDeletion as $userEpisodes) {
                        // need to save related object because we set the relation to null
                        $userEpisodes->save($con);
                    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $this->modifiedColumns[BookmarksTableMap::COL_ID] = true;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . BookmarksTableMap::COL_ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(BookmarksTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(BookmarksTableMap::COL_EPISODE_ID)) {
            $modifiedColumns[':p' . $index++]  = 'episode_id';
        }
        if ($this->isColumnModified(BookmarksTableMap::COL_NOTES)) {
        ...
        $sql = sprintf(
            'INSERT INTO bookmarks (%s) VALUES (%s)',
    ...
    {
        $pos = BookmarksTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['Bookmarks'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Bookmarks'][$this->hashCode()] = true;
        $keys = BookmarksTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
        ...
        if ($includeForeignObjects) {
            if (null !== $this->aEpisodes) {
                ...
                $result[$key] = $this->aEpisodes->toArray($keyType, $includeLazyLoadColumns,  $alreadyDumpedObjects, true);
            }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Models\Bookmarks\Bookmarks
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Models\Bookmarks\Bookmarks The current object, for fluid interface
     */
    ...
    {
        $criteria = new Criteria(BookmarksTableMap::DATABASE_NAME);

        if ($this->isColumnModified(BookmarksTableMap::COL_ID)) {
            $criteria->add(BookmarksTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(BookmarksTableMap::COL_EPISODE_ID)) {
            $criteria->add(BookmarksTableMap::COL_EPISODE_ID, $this->episode_id);
        }
        if ($this->isColumnModified(BookmarksTableMap::COL_NOTES)) {
            $criteria->add(BookmarksTableMap::COL_NOTES, $this->notes);
        }
        if ($this->isColumnModified(BookmarksTableMap::COL_CREATED_AT)) {
            $criteria->add(BookmarksTableMap::COL_CREATED_AT, $this->created_at);
        }
        if ($this->isColumnModified(BookmarksTableMap::COL_UPDATED_AT)) {
            $criteria->add(BookmarksTableMap::COL_UPDATED_AT, $this->updated_at);
        }
    ...
    {
        $criteria = ChildBookmarksQuery::create();
        $criteria->add(BookmarksTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Models\Bookmarks\Bookmarks (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Models\Bookmarks\Bookmarks Clone of current object.
     * @throws PropelException
     */
     ...
     * @throws PropelException
     */
    public function setEpisodes(Episodes $v = null)
    {
        if ($v === null) {
     ...
     * @throws PropelException
     */
    public function getEpisodes(ConnectionInterface $con = null)
    {
        if ($this->aEpisodes === null && (($this->episode_id !== "" && $this->episode_id !== null))) {
            $this->aEpisodes = EpisodesQuery::create()->findPk($this->episode_id, $con);
            /* The following can be used additionally to
                guarantee the related object contains a reference
                to this object.  This level of coupling may, however, be
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aEpisodes->addBookmarkss($this);
             */
        }

        return $this->aEpisodes;
    }
     ...
     * If this ChildBookmarks is new, it will return
     ...
     * @param      ConnectionInterface $con Optional connection object
     * @return $this|ChildBookmarks The current object (for fluent API support)
     */
    public function setUserEpisodess(Collection $userEpisodess, ConnectionInterface $con = null)
    {
        ...
        $this->userEpisodessScheduledForDeletion = $userEpisodessToDelete;

        foreach ($userEpisodessToDelete as $userEpisodesRemoved) {
            $userEpisodesRemoved->setBookmark(null);
        }
    ...
    public function removeUserEpisodes(UserEpisodes $userEpisodes)
    {
        if ($this->getUserEpisodess()->contains($userEpisodes)) {
            ...
            $this->userEpisodessScheduledForDeletion[]= $userEpisodes;
            $userEpisodes->setBookmark(null);
        }
     ...
     * Otherwise if this Bookmarks is new, it will return
     * an empty collection; or if this Bookmarks has previously
     * been saved, it will retrieve related UserEpisodess from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Bookmarks.
     *
     * @param      Criteria $criteria optional Criteria object to narrow the query
     * @param      ConnectionInterface $con optional connection object
    ...
    {
        if (null !== $this->aEpisodes) {
            $this->aEpisodes->removeBookmarks($this);
        }
        $this->id = null;
    ...
    {
        return (string) $this->exportTo(BookmarksTableMap::DEFAULT_STRING_FORMAT);
    }
