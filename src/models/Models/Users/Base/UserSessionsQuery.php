 ...
 *
 *
 * @method     ChildUserSessionsQuery orderById($order = Criteria::ASC) Order by the id column
 * @method     ChildUserSessionsQuery orderByUserId($order = Criteria::ASC) Order by the user_id column
 * @method     ChildUserSessionsQuery orderByExpDate($order = Criteria::ASC) Order by the exp_date column
 * @method     ChildUserSessionsQuery orderByHash($order = Criteria::ASC) Order by the hash column
 * @method     ChildUserSessionsQuery orderBySalt($order = Criteria::ASC) Order by the salt column
 *
 * @method     ChildUserSessionsQuery groupById() Group by the id column
 * @method     ChildUserSessionsQuery groupByUserId() Group by the user_id column
 * @method     ChildUserSessionsQuery groupByExpDate() Group by the exp_date column
 * @method     ChildUserSessionsQuery groupByHash() Group by the hash column
 * @method     ChildUserSessionsQuery groupBySalt() Group by the salt column
 *
 ...
 *
 * @method     ChildUserSessions findOne(ConnectionInterface $con = null) Return the first ChildUserSessions matching the query
 ...
 *
 * @method     ChildUserSessions findOneById(string $id) Return the first ChildUserSessions filtered by the id column
 * @method     ChildUserSessions findOneByUserId(string $user_id) Return the first ChildUserSessions filtered by the user_id column
 * @method     ChildUserSessions findOneByExpDate(string $exp_date) Return the first ChildUserSessions filtered by the exp_date column
 * @method     ChildUserSessions findOneByHash(string $hash) Return the first ChildUserSessions filtered by the hash column
 * @method     ChildUserSessions findOneBySalt(string $salt) Return the first ChildUserSessions filtered by the salt column *
 ...
 *
 * @method     ChildUserSessions requireOneById(string $id) Return the first ChildUserSessions filtered by the id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildUserSessions requireOneByUserId(string $user_id) Return the first ChildUserSessions filtered by the user_id column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildUserSessions requireOneByExpDate(string $exp_date) Return the first ChildUserSessions filtered by the exp_date column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildUserSessions requireOneByHash(string $hash) Return the first ChildUserSessions filtered by the hash column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildUserSessions requireOneBySalt(string $salt) Return the first ChildUserSessions filtered by the salt column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 *
 * @method     ChildUserSessions[]|ObjectCollection find(ConnectionInterface $con = null) Return ChildUserSessions objects based on current ModelCriteria
 * @method     ChildUserSessions[]|ObjectCollection findById(string $id) Return ChildUserSessions objects filtered by the id column
 * @method     ChildUserSessions[]|ObjectCollection findByUserId(string $user_id) Return ChildUserSessions objects filtered by the user_id column
 * @method     ChildUserSessions[]|ObjectCollection findByExpDate(string $exp_date) Return ChildUserSessions objects filtered by the exp_date column
 * @method     ChildUserSessions[]|ObjectCollection findByHash(string $hash) Return ChildUserSessions objects filtered by the hash column
 * @method     ChildUserSessions[]|ObjectCollection findBySalt(string $salt) Return ChildUserSessions objects filtered by the salt column
...
abstract class UserSessionsQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Models\Users\Base\UserSessionsQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'default', $modelName = '\\Models\\Users\\UserSessions', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT id, user_id, exp_date, hash, salt FROM user_sessions WHERE id = :p0';
        try {
     ...
     * @param     mixed $key Primary key to use for the query
     *
     * @return $this|ChildUserSessionsQuery The current query, for fluid interface
     */
    public function filterByPrimaryKey($key)
    {

        return $this->addUsingAlias(UserSessionsTableMap::COL_ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(UserSessionsTableMap::COL_ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UserSessionsTableMap::COL_ID, $id, $comparison);
    }
    ...
    public function filterByUserId($userId = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UserSessionsTableMap::COL_USER_ID, $userId, $comparison);
    }
    ...
    public function filterByExpDate($expDate = null, $comparison = null)
    {
        if (is_array($expDate)) {
            ...
            if (isset($expDate['min'])) {
                $this->addUsingAlias(UserSessionsTableMap::COL_EXP_DATE, $expDate['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($expDate['max'])) {
                $this->addUsingAlias(UserSessionsTableMap::COL_EXP_DATE, $expDate['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(UserSessionsTableMap::COL_EXP_DATE, $expDate, $comparison);
    }
    ...
    public function filterByHash($hash = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UserSessionsTableMap::COL_HASH, $hash, $comparison);
    }
    ...
    public function filterBySalt($salt = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(UserSessionsTableMap::COL_SALT, $salt, $comparison);
    }
     ...
     * @throws \Propel\Runtime\Exception\PropelException
     *
     * @return ChildUserSessionsQuery The current query, for fluid interface
     */
    public function filterByUsers($users, $comparison = null)
    {
        if ($users instanceof \Models\Users\Users) {
            return $this
                ->addUsingAlias(UserSessionsTableMap::COL_USER_ID, $users->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(UserSessionsTableMap::COL_USER_ID, $users->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    {
        if ($userSessions) {
            $this->addUsingAlias(UserSessionsTableMap::COL_ID, $userSessions->getId(), Criteria::NOT_EQUAL);
        }
