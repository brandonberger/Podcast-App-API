...
class UsersTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Models.Users.Map.UsersTableMap';
     ...
     */
    const OM_CLASS = '\\Models\\Users\\Users';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Models.Users.Users';
     ...
     */
    const COL_GOOGLE_ID = 'users.google_id';

    /**
     * the column name for the image_url field
     */
    const COL_IMAGE_URL = 'users.image_url';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Email', 'FirstName', 'LastName', 'Active', 'GoogleId', 'ImageUrl', ),
        self::TYPE_CAMELNAME     => array('id', 'email', 'firstName', 'lastName', 'active', 'googleId', 'imageUrl', ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID, UsersTableMap::COL_EMAIL, UsersTableMap::COL_FIRST_NAME, UsersTableMap::COL_LAST_NAME, UsersTableMap::COL_ACTIVE, UsersTableMap::COL_GOOGLE_ID, UsersTableMap::COL_IMAGE_URL, ),
        self::TYPE_FIELDNAME     => array('id', 'email', 'first_name', 'last_name', 'active', 'google_id', 'image_url', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Email' => 1, 'FirstName' => 2, 'LastName' => 3, 'Active' => 4, 'GoogleId' => 5, 'ImageUrl' => 6, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'email' => 1, 'firstName' => 2, 'lastName' => 3, 'active' => 4, 'googleId' => 5, 'imageUrl' => 6, ),
        self::TYPE_COLNAME       => array(UsersTableMap::COL_ID => 0, UsersTableMap::COL_EMAIL => 1, UsersTableMap::COL_FIRST_NAME => 2, UsersTableMap::COL_LAST_NAME => 3, UsersTableMap::COL_ACTIVE => 4, UsersTableMap::COL_GOOGLE_ID => 5, UsersTableMap::COL_IMAGE_URL => 6, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'email' => 1, 'first_name' => 2, 'last_name' => 3, 'active' => 4, 'google_id' => 5, 'image_url' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Models\\Users\\Users');
        ...
        $this->addColumn('google_id', 'GoogleId', 'VARCHAR', true, 255, null);
    ...
    {
        $this->addRelation('UserSessions', '\\Models\\Users\\UserSessions', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':user_id',
    1 => ':id',
        ...
        $this->addRelation('UserRelationsRelatedByFollowerId', '\\Models\\Users\\UserRelations', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':follower_id',
    1 => ':id',
  ),
), null, null, 'UserRelationssRelatedByFollowerId', false);
        $this->addRelation('UserRelationsRelatedByFollowingId', '\\Models\\Users\\UserRelations', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':following_id',
    1 => ':id',
  ),
), null, null, 'UserRelationssRelatedByFollowingId', false);
        $this->addRelation('AudioPlayerSettings', '\\Models\\AudioPlayerSettings\\AudioPlayerSettings', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':user_id',
    1 => ':id',
  ),
), null, null, 'AudioPlayerSettingss', false);
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('Following', '\\Models\\Users\\Users', RelationMap::MANY_TO_MANY, array(), null, null, 'Followings');
        $this->addRelation('Follower', '\\Models\\Users\\Users', RelationMap::MANY_TO_MANY, array(), null, null, 'Followers');
        $this->addRelation('Podcasts', '\\Models\\Podcasts\\Podcasts', RelationMap::MANY_TO_MANY, array(), null, null, 'Podcastss');
        $this->addRelation('Playlists', '\\Models\\Playlists\\Playlists', RelationMap::MANY_TO_MANY, array(), null, null, 'Playlistss');
        $this->addRelation('PlaylistsTags', '\\Models\\Playlists\\Playlists', RelationMap::MANY_TO_MANY, array(), null, null, 'PlaylistsTagss');
        $this->addRelation('PlaylistTag', '\\Models\\Tags\\Tags', RelationMap::MANY_TO_MANY, array(), null, null, 'PlaylistTags');
        $this->addRelation('EpisodesTags', '\\Models\\Episodes\\Episodes', RelationMap::MANY_TO_MANY, array(), null, null, 'EpisodesTagss');
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(UsersTableMap::COL_IMAGE_URL);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Models\Users\Users) { // it's a model object
